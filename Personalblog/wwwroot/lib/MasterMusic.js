const aPlayer = new APlayer({
    ...
    music: [
        ...
        {
            title:'主角', 
            author:'沉画文阁,马里奥,曲杨,draceana',
            url:'http://music.163.com/song/media/outer/url?id=2161503002.mp3',
            pic:'http://p1.music.126.net/GydBHMkoBHmIAszwTmixVg==/109951169632692426.jpg?param=300x300',
        ...
        {
            title:'Wings！You Are My Future',
            author:'Wthegg',
            url:'http://music.163.com/song/media/outer/url?id=1427978795.mp3',
            pic:'http://p1.music.126.net/VYrOp9s17r8DWvKKwkmWIw==/109951164765426714.jpg?param=300x300',
            lrc:'[00:00.00] 暂无歌词',
        }
    ]
});
